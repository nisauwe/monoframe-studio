...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="discount-create-shell">

      {{-- HERO HEADER --}}
      <div class="discount-create-hero mb-4">
        <div class="discount-create-hero-left">
          <div class="discount-create-hero-icon">
            <i class="bx bx-purchase-tag-alt"></i>
          </div>

          <div>
            <div class="discount-create-kicker">MANAJEMEN DISKON</div>
            <h4>Tambah Diskon</h4>
            <p>
              Buat promo diskon baru dengan memilih kategori, paket foto, besar diskon,
              periode promo, dan status aktif diskon Monoframe Studio.
            </p>
          </div>
        </div>

        <div class="discount-create-hero-actions">
          <a href="{{ route('admin.packages.index', ['tab' => 'discounts']) }}" class="btn discount-create-back-btn">
      ...
      {{-- ALERT ERROR --}}
      @if (session('error'))
        <div class="alert alert-danger alert-dismissible fade show mb-4 discount-create-alert" role="alert">
      ...
      <form action="{{ route('admin.discounts.store') }}" method="POST" id="discountForm">
        ...
        <div class="row g-4">
          ...
          <div class="col-xl-8 col-lg-7">
            <div class="card discount-create-card">
              <div class="card-header">
                <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
                  <div>
                    <h5 class="mb-1">Form Tambah Diskon</h5>
                    <p class="mb-0">
                      Pilih kategori terlebih dahulu, lalu tentukan paket foto yang akan mendapatkan diskon.
                    </p>
                  </div>
              ...
              <div class="card-body">
                ...
                <div class="discount-form-section">
                  <div class="discount-section-heading">
                    ...
                    <div>
                      <h6>Detail Promo</h6>
                      <p>Isi nama promo, kategori, persentase diskon, tanggal promo, dan status diskon.</p>
                    </div>
                  </div>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-text">
                        Paket akan muncul setelah kategori dipilih.
                      </div>
                    </div>
                ...
                <div class="discount-form-section mb-0">
                  <div class="discount-section-heading">
                    ...
                    <div>
                      <h6>Pilih Paket</h6>
                      <p>Centang paket foto yang ingin diberi diskon sesuai kategori yang dipilih.</p>
                    </div>
                  </div>
          ...
          <div class="col-xl-4 col-lg-5">
            <div class="discount-side-sticky">
              <div class="discount-preview-card">
                <div class="discount-preview-head">
                  <div>
                    ...
                    <h6 id="previewPromoName">Promo Diskon Baru</h6>
                  </div>
                ...
                <div class="discount-preview-hero">
                  ...
                  <div>
                    <div class="discount-preview-percent" id="previewPercent">0%</div>
              ...
              <div class="discount-helper-card mt-4">
                ...
                <h6>Tips Diskon</h6>
                <p>
                  Gunakan diskon dengan periode yang jelas agar promo lebih mudah dipantau
                  dan tidak aktif terlalu lama tanpa sengaja.
                </p>

                <div class="discount-helper-list">
                  <div class="discount-helper-item">
                    <i class="bx bx-check-circle"></i>
                    <span>Pilih kategori dulu sebelum memilih paket.</span>
                  </div>

                  <div class="discount-helper-item">
                    <i class="bx bx-check-circle"></i>
                    <span>Gunakan persentase diskon yang masuk akal.</span>
                  </div>

                  <div class="discount-helper-item">
                    <i class="bx bx-check-circle"></i>
                    <span>Nonaktifkan promo jika masa promo sudah selesai.</span>
                  </div>
                </div>
              </div>
            </div>
  ...
  <style>
    ...
    .discount-create-hero-actions {
      position: relative;
      z-index: 2;
      flex-shrink: 0;
    }

    .discount-create-back-btn {
      min-height: 54px;
      border: 0;
      border-radius: 18px;
    ...
    .discount-create-back-btn:hover {
      background: #ffffff;
      color: var(--mf-primary);
    ...
    .discount-create-alert {
      border: 0;
      border-radius: 20px;
      box-shadow: var(--mf-shadow-soft);
    }

    .discount-create-alert i {
      font-size: 20px;
    }

    .discount-create-card,
    ...
    .discount-create-card .card-header {
    ...
    .discount-create-card .card-header h5 {
      color: var(--mf-ink);
      font-weight: 900;
    }

    .discount-create-card .card-header p {
      color: var(--mf-muted);
      font-size: 14px;
      font-weight: 600;
      line-height: 1.6;
    ...
    .discount-create-card .card-body {
    ...
    .discount-create-card .form-label {
      color: var(--mf-ink);
      font-size: 12px;
      font-weight: 900;
    ...
    .discount-create-card .form-control,
    .discount-create-card .form-select {
      min-height: 54px;
    ...
    .discount-create-card .form-control:focus,
    .discount-create-card .form-select:focus {
      border-color: rgba(88, 115, 220, 0.48) !important;
      box-shadow: 0 0 0 0.22rem rgba(88, 115, 220, 0.10) !important;
    }

    .discount-create-card .form-text {
      color: var(--mf-muted);
      font-size: 12px;
      font-weight: 600;
      margin-top: 8px;
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function updatePreview() {
        ...
        previewPromoName.textContent = promoName || 'Promo Diskon Baru';
