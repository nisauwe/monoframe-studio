...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h4 class="fw-bold mb-1">Tambah Diskon</h4>
        <p class="text-muted mb-0">Buat promo diskon baru untuk beberapa paket sekaligus.</p>
      </div>
        ...
        <form action="{{ route('admin.discounts.store') }}" method="POST">
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="date" name="discount_start_at" class="form-control" value="{{ old('discount_start_at') }}">
            </div>

            <div class="col-md-4 mb-3">
              <label class="form-label">Selesai Tanggal</label>
              <input type="date" name="discount_end_at" class="form-control" value="{{ old('discount_end_at') }}">
            </div>
          ...
          <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary">
              <i class="bx bx-save me-1"></i> Simpan Diskon
            </button>
