...
@section('title', 'Edit Paket Cetak')

@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
    <div class="print-edit-shell">

      {{-- HERO HEADER --}}
      <div class="print-edit-hero mb-4">
        <div class="print-edit-hero-left">
          <div class="print-edit-hero-icon">
            <i class="bx bx-edit-alt"></i>
          </div>

          <div>
            <div class="print-edit-kicker">MANAJEMEN PAKET CETAK</div>
            <h4>Edit Paket Cetak</h4>
            <p>
              Perbarui ukuran cetak, harga cetak, harga bingkai, catatan, dan status
              paket cetak Monoframe Studio.
            </p>
          </div>
        </div>

        <div class="print-edit-hero-actions">
          <a href="{{ route('admin.packages.index', ['tab' => 'print-prices']) }}" class="btn print-edit-back-btn">
      ...
      {{-- ERROR ALERT --}}
      @if ($errors->any())
        <div class="alert alert-danger alert-dismissible fade show mb-4 print-edit-alert" role="alert">
      ...
      <div class="row g-4">
        <div class="col-lg-8">
          <div class="card print-edit-card">
            <div class="card-header">
              <div>
                <h5 class="mb-1">Form Edit Paket Cetak</h5>
                <p class="mb-0">
                  Ubah data paket cetak sesuai kebutuhan. Perubahan akan langsung digunakan pada sistem.
                </p>
              </div>
            </div>

            <div class="card-body">
              <form action="{{ route('admin.print-prices.update', $printPrice->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="print-form-section">
                  <div class="print-section-heading">
                    ...
                    <div>
                      ...
                      <p>
                        Perbarui ukuran cetak, harga cetak, harga bingkai, status, dan catatan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="row g-3">
                    <div class="col-md-6">
                      ...
                      <input
                        ...
                        id="size_label"
                        class="form-control"
                        value="{{ old('size_label', $printPrice->size_label) }}"
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group print-input-group">
                        ...
                        <input
                          ...
                          id="base_price"
                          class="form-control"
                          value="{{ old('base_price', $printPrice->base_price) }}"
                          min="0"
                          required>
                      </div>
                      <div class="form-text">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="input-group print-input-group">
                        ...
                        <input
                          ...
                          id="frame_price"
                          class="form-control"
                          value="{{ old('frame_price', $printPrice->frame_price) }}"
                          min="0"
                          required>
                      </div>
                      <div class="form-text">
                        Isi 0 jika paket cetak ini tidak menyediakan bingkai.
                      </div>
                    </div>
                      ...
                      <div class="print-status-card">
                        ...
                        <div class="form-check form-switch print-switch mb-0">
                          <input
                            ...
                            name="is_active"
                            value="1"
                            {{ old('is_active', $printPrice->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                      ...
                      <textarea
                        ...
                        placeholder="Catatan tambahan (opsional)">{{ old('notes', $printPrice->notes) }}</textarea>
                      <div class="form-text">
        ...
        <div class="col-lg-4">
          <div class="print-side-sticky">
            <div class="print-helper-card">
              ...
              <h5>Tips Edit Cetak</h5>
              <p>
                Pastikan harga cetak dan harga bingkai sudah sesuai sebelum paket ditampilkan
                kembali ke klien.
              </p>
              ...
              <div class="print-helper-list">
                <div class="print-helper-item">
                  ...
                  <span>Gunakan label ukuran yang jelas.</span>
                </div>
            ...
            <div class="print-preview-card mt-4">
              <div class="print-preview-head">
                <div>
                  ...
                  <h6 id="previewPrintTitle">Paket Cetak {{ old('size_label', $printPrice->size_label) }}</h6>
                </div>

                <span
                  class="badge {{ old('is_active', $printPrice->is_active) ? 'bg-label-success' : 'bg-label-secondary' }}"
                  id="previewStatusBadge">
                  {{ old('is_active', $printPrice->is_active) ? 'Aktif' : 'Tidak Aktif' }}
                </span>
              </div>
              ...
              <div class="print-preview-body">
                ...
                <div>
                  <div class="print-preview-title" id="previewSizeLabel">
                    {{ old('size_label', $printPrice->size_label) ?: 'Ukuran Cetak' }}
                  </div>
                  <div class="print-preview-subtitle" id="previewNotesText">
                    {{ old('notes', $printPrice->notes) ?: 'Harga cetak dan bingkai akan tampil di daftar paket cetak.' }}
                  </div>
                </div>
              </div>
              ...
              <div class="print-preview-price-grid">
                <div>
                  ...
                  <strong id="previewBasePrice">
                    Rp {{ number_format((int) old('base_price', $printPrice->base_price), 0, ',', '.') }}
                  </strong>
                </div>

                <div>
                  <small>Harga Bingkai</small>
                  <strong id="previewFramePrice">
                    Rp {{ number_format((int) old('frame_price', $printPrice->frame_price), 0, ',', '.') }}
                  </strong>
                </div>
              </div>
            </div>
    ...
    <style>
      ...
      .print-edit-card .card-header h5 {
        color: var(--mf-ink);
        font-weight: 900;
      }

      .print-edit-card .card-header p {
        color: var(--mf-muted);
        font-size: 14px;
        font-weight: 600;
        line-height: 1.6;
